...
const AllCourses: FC<Props> = ({ isTeam }) => {
    ...
    const [deleteUser, { isSuccess: deleteSucces, error: deleteError }] = useDeleteUserMutation({});
    ...
    }, [updateError, isSuccess, deleteSucces, deleteError])
                    ...
                    <Box m="20px">
                        {isTeam && (
                            <div className="w-full flex justify-end">
                                <div
                                    className={`${styles.button} !w-[200px] !rounded-[10px] dark:bg-[#57c7a3] !h-[35px] dark:border-[#ffffff6c]`}
